...
Route::get('linh-vuc-hoat-dong',['as'=>'getProduct', 'uses'=>'IndexController@getProduct']);
Route::get('linh-vuc/{alias}.html','IndexController@getProductDetail')->name('detailProduct');
Route::get('linh-vuc/{id}',['as'=>'getProductList', 'uses'=>'IndexController@getProductList']);
