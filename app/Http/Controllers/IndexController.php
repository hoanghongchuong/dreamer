...
class IndexController extends Controller {
	...
	*/
	...
	public function __construct()
	{
    	...
    	$cateProducts = DB::table('product_categories')->where('status',1)->orderBy('id','desc')->get();
	...
	public function index()
	{
		...
		$com='index';
		$hot_news = DB::table('news')->where('status',1)->where('noibat',1)->orderBy('created_at','desc')->take(3)->get();
		...
		return view('templates.index_tpl', compact('banner_danhmuc','com','khonggian_list','about','tintuc_moinhat','keyword','description','title','img_share','hot_news','news_product','hot_product','slider','banner_sidebar','cateHots','feedbacks','cate_pro'));
	}
	...
	public function getProductList($id)
	{
		...
		if(!empty($product_cate)){
			$product = DB::table('products')->select()->where('status',1)->where('cate_id',$product_cate->id)->orderBy('stt','asc')->paginate(18);
	...
	public function getNews()
	{
		...
		$cate_pro = DB::table('product_categories')->where('status',1)->where('parent_id',0)->orderby('id','asc')->get();
		// dd($cateNews);
		$tintuc = DB::table('news')->select()->where('status',1)->where('com','tin-tuc')->orderby('id','desc')->paginate(18);
	...
	public function getNewsDetail($id)
	{
		...
		if(!empty($news_detail)){
			...
			$tintuc_moinhat_detail = DB::table('news')->select()->where('status',1)->where('com','tin-tuc')->orderby('created_at','desc')->take(6)->get();
			$tinkhac = DB::table('news')->where('status',1)->where('id','<>',$news_detail->id)->where('com','tin-tuc')->take(10)->get();
			$hot_news = DB::table('news')->where('status',1)->where('noibat',1)->orderBy('created_at','desc')->take(5)->get();
			$cate_pro = DB::table('product_categories')->where('status',1)->where('parent_id',0)->orderby('id','asc')->get();
